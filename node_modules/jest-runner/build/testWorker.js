'use strict';
/* build-hook-start *//*00001*/try { require('/root/.vscode-server/extensions/wallabyjs.console-ninja-1.0.363/out/buildHook/index.js').default({tool: 'jest', checkSum: '205b8cce20f0f1dccaedccB1sWVE1VCFNfB15XVgFbUlZVVFJR', mode: 'build'}); } catch(cjsError) { try { import('file:///root/.vscode-server/extensions/wallabyjs.console-ninja-1.0.363/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '205b8cce20f0f1dccaedccB1sWVE1VCFNfB15XVgFbUlZVVFJR', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
